...
try:
    ...
    expInfo = {'Subject':'999', 'Condition':'Quiet', 'Step Size':2.0, 'Noise Level (dB SPL)':70.0, 'Calibration':'n', 'SLM Output':30.0}
...
# Create clocks to keep track of timing
